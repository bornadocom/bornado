...
function mcew_get_style3_meta_text( $ad_id ) {
	...
	$cache_key = 'mcew_style3_meta_' . $ad_id;
	...
	if ( function_exists( 'adforest_human_time_diff' ) ) {
		$posted = adforest_human_time_diff( get_post_time( 'U', true, $ad_id ), current_time( 'timestamp' ) ) . ' ' . __( 'پیش', 'my-custom-widgets' );
	} else {
		$posted = human_time_diff( get_post_time( 'U', true, $ad_id ), current_time( 'timestamp' ) ) . ' ' . __( 'پیش', 'my-custom-widgets' );
	}
