 ...
 */
$bornado_header_clone_bootstrap = trailingslashit(get_stylesheet_directory()) . 'My-Customization/adforest-header-search-4-clone/adforest-header-search-4-clone.php';
