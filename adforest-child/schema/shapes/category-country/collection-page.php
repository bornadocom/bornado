...
if (!function_exists('bornado_schema_manager_build_category_country_collection_page_entity')) {
    /**
     * CollectionPage schema for country + category routes like /uk/property/.
     *
     ...
     */
    function bornado_schema_manager_build_category_country_collection_page_entity(array $entity, $page_type, array $route_context)
    {
        ...
        return apply_filters('bornado_schema_manager_category_country_collection_entity', $entity, $route_context, $category_context);
    }
}
