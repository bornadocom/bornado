...
class AboutUsEvents extends Widget_Base
{

    public function get_name()
    {
        return 'about_us_events_exp_short_base';
    }

    public function get_title()
    {
        return __('Event Experience', 'adforest-elementor');
    }
    ...
    protected function render()
    {
        ...
        if (function_exists('about_us_events_exp_short_base')) {
            echo about_us_events_exp_short_base($params);
        }
    }
}