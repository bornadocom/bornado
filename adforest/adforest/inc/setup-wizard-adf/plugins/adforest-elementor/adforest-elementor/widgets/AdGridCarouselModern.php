...
class AdGridCarouselModern extends Widget_Base
{
    public function get_name()
    {
        return 'adforest_ad_grid_carousel_modern';
    }

    public function get_title()
    {
        return __("Ad Grid Carousel Modern", 'adforest-elementor');
    }
    ...
    protected function render()
    {
        ...
        if (function_exists('adforest_ad_grid_carousel_modern_shortcode')) {
            echo adforest_ad_grid_carousel_modern_shortcode($params);
        }
