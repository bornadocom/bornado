...
/* Only need on this page so included here don't want to increase page size for optimization by adding extra scripts in all the web */
                ...
                <div class="adt-ads-filter-content-wrapper">
                    ...
                    <div class="adt-ads-filter-content">
                        <div class="adt-ads-sort-box">
                            <h3>
								<?php echo esc_html( $query->found_posts ) . ' ' . esc_html__( 'Ad(s) Found:', 'adforest' ); ?>
								<?php
                            ...
                            <div class="adt-sort-filters">
                                ...
                                <div class="adt-change-view-box">
									...
									$list_view = adforest_custom_remove_url_query( 'view-type', 'list' );
										...
										$default_view = isset( $adforest_theme['search_ad_layout_for_search'] ) ? $adforest_theme['search_ad_layout_for_search'] : 'grid';
									...
									if ( isset( $adforest_theme['search_layout_types'] ) && $adforest_theme['search_layout_types'] == true ) {
										?>
                                        <a href="<?php echo esc_url( $grid_view ); ?>" class="icon-box grid <?php echo esc_attr($grid_active); ?>">
                                            <i class="fas fa-th-large"></i>
                                        </a>
                                        <a href="<?php echo esc_url( $list_view ); ?>" class="icon-box list <?php echo esc_attr($list_active); ?>">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                                                <a href="javascript:void(0)" style="padding: 10px"
                                                   class="adt-button-dark ad_alerts"><?php echo esc_html__( 'Create Alert', 'adforest' ) ?></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
