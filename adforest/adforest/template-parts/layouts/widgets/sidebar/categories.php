...
if ( count($ad_categories) > 0 ) {
    ...
    <div class="accordion-item">
        ...
        <form method="get" id="search_cats_w" action="<?php echo adforest_return_echo($adforest_search_page); ?>">
            ...
            <div id="panelsStayOpen-collapseTwo" class="accordion-collapse collapse <?php echo esc_attr($expand); ?>">
                        ...
                        <ul>
							...
							<?php if ( !empty($rest_categories) ) { ?>
                                ...
                                <li class="toggle-wrapper">
                                    <a href="javascript:void(0);" id="showMoreCategories"><?php _e('Show More', 'adforest'); ?></a>
                                    <a href="javascript:void(0);" id="showLessCategories" style="display: none;"><?php _e('Show Less', 'adforest'); ?></a>
                                </li>
							<?php } ?>
                        </ul>
                    </div>
