...
$btn_other     = '<button class="crosshair_btn crosshair-btn-topbar" type="button" id="you_current_location_text" data-place="text_field"><i class="fa fa-crosshairs"></i></button>';
$btn_search1   = '';
if ( $show_hide == 'hide' ) {
	$display_style = 'hideSearchInput';
} else {
	$btn_search1 = '<button class="search-btn-title" type="submit" id="btn-submit"><i class="fa fa-search"></i></button>';
	$btn_search  = '';
}
...
<div class="col-sm-6 col-md-4 col-lg-3">
    <form id="sb-radius-form" class="for-radius d-flex align-items-center gap-1">
        <div class="form-field">
            <label for="radius-search"
                   class="form-label"><?php echo __( "Radius Search", 'adforest' ); ?></label>
            <div class="form-field-sub">
                <?php
                ...
                if ( $mapType == 'leafletjs_map' ) {
                    $map_lat  = isset($_GET['lat']) ? $_GET['lat'] : '';
                    $map_long = isset($_GET['long']) ? $_GET['long'] : '';
                ...
                ';
                    ...
                    $btn_other = '<button class="crosshair_btn crosshair-btn-topbar" type="button" id="get-location" data-place="text_field"><i class="fa fa-crosshairs"></i></button>';
                }
                ...
                <div>
                    <?php echo wp_kses_post($btn_search); ?>
                    <?php echo wp_kses_post($btn_other); ?>
                </div>
