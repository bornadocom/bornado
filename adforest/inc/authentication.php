...
if (!function_exists('adforest_get_header_user_menu_markup')) {
    ...
    function adforest_get_header_user_menu_markup($args = array())
    {
        ...
        $modern_menu_enabled = !empty($adforest_theme['sb_header_user_menu_style']);

        // Modern (Listivo-style) user menu — only for logged-in users.
        // Logged-out visitors continue to see the Sign in / Register links below.
        if ($modern_menu_enabled && is_user_logged_in()) {
            $current_user   = wp_get_current_user();
            $display_name   = $current_user->display_name ?: $current_user->user_login;
            $dp             = function_exists('adforest_get_user_dp') ? adforest_get_user_dp($user_id) : '';
            ...
            $dash_url       = trailingslashit(get_the_permalink($sb_profile_page));

            $msg_count = function_exists('adforest_get_message_count') ? adforest_get_message_count() : 0;

            // Emit scoped inline styles once per page so the modern menu
            // shows the username and opens on hover without touching global CSS/JS.
            static $modern_styles_printed = false;
            $inline_style = '';
            if (!$modern_styles_printed) {
                $modern_styles_printed = true;
                // Selectors chain BOTH modifier classes (.adt-user-avatar.adt-user-avatar--modern
                // and .dropdown-user-login.dropdown-user-login--modern) so specificity (0,4,x)
                // outranks the theme's existing .sb-header .adt-list .dropdown-user-login li a
                // !important rules (0,3,x) regardless of where the menu is placed.
                $inline_style = '<style id="adforest-modern-user-menu-css">'
                    /* Make the parent <li class="adt-list"> a flex row so the avatar trigger
                       and the "Post an Ad" button vertically center next to each other.
                       Scoped via :has(.adt-user-avatar--modern) so classic mode stays untouched. */
                    . '.sb-menu > ul > li.adt-list:has(.adt-user-avatar--modern){display:inline-flex !important;align-items:center;gap:14px;flex-wrap:nowrap;}'
                    . '.sb-menu > ul > li.adt-list:has(.adt-user-avatar--modern) .ad-post-btn{margin:0;}'
                    /* Trigger (avatar + username, sits next to Post Ad button) */
                    . '.adt-user-avatar.adt-user-avatar--modern{position:relative;display:inline-flex;align-items:center;vertical-align:middle;}'
                    . '.adt-user-avatar.adt-user-avatar--modern .adt-user-trigger{display:inline-flex;align-items:center;gap:10px;color:#242424;text-decoration:none;cursor:pointer;line-height:1;padding:6px 8px;}'
                    . '.adt-user-avatar.adt-user-avatar--modern .adt-user-trigger img{width:34px;height:34px;border-radius:50%;object-fit:cover;border:0;flex-shrink:0;}'
                    . '.adt-user-avatar.adt-user-avatar--modern .adt-user-name{font-size:14px;font-weight:500;color:#242424;white-space:nowrap;}'
                    /* Dropdown shell */
                    . '.adt-user-avatar.adt-user-avatar--modern .dropdown-user-login.dropdown-user-login--modern{display:none;position:absolute;top:100%;right:0;min-width:260px;background:#fff;border-radius:12px;box-shadow:0 10px 30px rgba(15,23,42,0.10);padding:10px !important;margin:8px 0 0;z-index:9999;list-style:none;}'
                    /* Hover / keyboard-focus opens it (no JS needed) */
                    . '.adt-user-avatar.adt-user-avatar--modern:hover .dropdown-user-login.dropdown-user-login--modern,'
                    . '.adt-user-avatar.adt-user-avatar--modern:focus-within .dropdown-user-login.dropdown-user-login--modern{display:block !important;}'
                    /* Items */
                    . '.adt-user-avatar.adt-user-avatar--modern .dropdown-user-login.dropdown-user-login--modern li{padding:0 !important;list-style:none;line-height:1.3;margin:0;}'
                    . '.adt-user-avatar.adt-user-avatar--modern .dropdown-user-login.dropdown-user-login--modern li a{display:flex !important;align-items:center;gap:14px;padding:11px 14px !important;border-radius:8px;color:#1f2937 !important;font-size:13px;font-weight:500;text-decoration:none;line-height:1.3;transition:background .15s ease,color .15s ease;}'
                    . '.adt-user-avatar.adt-user-avatar--modern .dropdown-user-login.dropdown-user-login--modern li a i{width:18px;color:#6b7280;font-size:15px;text-align:center;flex-shrink:0;}'
                    . '.adt-user-avatar.adt-user-avatar--modern .dropdown-user-login.dropdown-user-login--modern li a:hover{background:#f6f7fb;color:#ff3d00 !important;}'
                    . '.adt-user-avatar.adt-user-avatar--modern .dropdown-user-login.dropdown-user-login--modern li a:hover i{color:#ff3d00;}'
                    /* Badge */
                    . '.adt-user-avatar.adt-user-avatar--modern .dropdown-user-login.dropdown-user-login--modern li a .badge{margin-left:auto;font-size:11px;font-weight:700;padding:3px 9px;border-radius:999px;background:#ff3d00 !important;color:#fff !important;line-height:1;}'
                    /* Divider */
                    . '.adt-user-avatar.adt-user-avatar--modern .dropdown-user-login.dropdown-user-login--modern .adt-user-divider{height:1px;background:#eef0f4;margin:8px 4px;padding:0 !important;}'
                    /* Tablet/mobile breakpoint */
                    . '@media (max-width:991.98px){'
                    .   '.adt-user-avatar.adt-user-avatar--modern .adt-user-name{display:none;}'
                    .   '.adt-user-avatar.adt-user-avatar--modern .dropdown-user-login.dropdown-user-login--modern{right:auto;left:0;}'
                    . '}'
                    /* ============================================================
                     * RTL overrides — flip directional rules when WordPress adds
                     * `class="rtl"` to <body>. Cascades over everything above.
                     * ========================================================== */
                    . 'body.rtl .adt-user-avatar.adt-user-avatar--modern .dropdown-user-login.dropdown-user-login--modern{right:auto;left:0;}'
                    . 'body.rtl .adt-user-avatar.adt-user-avatar--modern .dropdown-user-login.dropdown-user-login--modern li a .badge{margin-left:0;margin-right:auto;}'
                    . '@media (max-width:991.98px){'
                    .   'body.rtl .adt-user-avatar.adt-user-avatar--modern .dropdown-user-login.dropdown-user-login--modern{left:auto;right:0;}'
                    . '}'
                    . '</style>';
            }
            ?>
            <?php echo $inline_style; ?>
            <div class="adt-user-avatar adt-user-avatar--modern">
                <a href="javascript:void(0)" class="adt-user-trigger" aria-haspopup="true" aria-expanded="false">
                    <img src="<?php echo esc_url($dp); ?>"
                         alt="<?php echo esc_attr__('user profile picture', 'adforest'); ?>" width="32" height="32">
                    <span class="adt-user-name"><?php echo esc_html($display_name); ?></span>
                </a>
                <ul class="dropdown-user-login dropdown-user-login--modern">
                    <?php
                    // Add Listing → standalone Modern page (selected via Theme Options).
                    // Falls back to the classic Post Ad page if none picked yet.
                    $modern_post_ad_page_id = isset($adforest_theme['sb_modern_post_ad_page']) ? $adforest_theme['sb_modern_post_ad_page'] : '';
                    $add_listing_url = $modern_post_ad_page_id
                        ? get_permalink($modern_post_ad_page_id)
                        : get_the_permalink($sb_post_ad_page);
                    ?>
                    <li><a class="user_login_dropdown_text" href="<?php echo esc_url($add_listing_url); ?>">
                        <i class="fa fa-plus-circle"></i> <?php echo esc_html__('Add Listing', 'adforest'); ?>
                    </a></li>
                    <?php
                    // Awaiting Approval → standalone Modern page (selected via Theme Options)
                    // Falls back to the dashboard's classic Inactive Ads page if none picked yet.
                    ...
                    $awaiting_url = $modern_pending_page_id
                        ? get_permalink($modern_pending_page_id)
                        : adforest_set_url_param($dash_url, 'page_type', 'inactive_ads');
                    ?>
                    <li><a class="user_login_dropdown_text" href="<?php echo esc_url($awaiting_url); ?>">
                        <i class="fa fa-clipboard-check"></i> <?php echo esc_html__('Awaiting Approval', 'adforest'); ?>
                    </a></li>
                    <?php
                    // Invoices → standalone Modern page (selected via Theme Options)
                    // Falls back to the dashboard's classic Invoices page if none picked yet.
                    $modern_invoices_page_id = isset($adforest_theme['sb_modern_invoices_page']) ? $adforest_theme['sb_modern_invoices_page'] : '';
                    $invoices_url = $modern_invoices_page_id
                        ? get_permalink($modern_invoices_page_id)
                        : adforest_set_url_param($dash_url, 'page_type', 'invoices');
                    ?>
                    <li><a class="user_login_dropdown_text" href="<?php echo esc_url($invoices_url); ?>">
                        <i class="fa fa-receipt"></i> <?php echo esc_html__('Invoices', 'adforest'); ?>
                    </a></li>
                    <?php
                    // My Listings → standalone Modern page (selected via Theme Options)
                    // Falls back to the dashboard's classic My Ads page if none picked yet.
                    $modern_listings_page_id = isset($adforest_theme['sb_modern_my_listings_page']) ? $adforest_theme['sb_modern_my_listings_page'] : '';
                    $my_listings_url = $modern_listings_page_id
                        ? get_permalink($modern_listings_page_id)
                        : adforest_set_url_param($dash_url, 'page_type', 'my_ads');
                    ?>
                    <li><a class="user_login_dropdown_text" href="<?php echo esc_url($my_listings_url); ?>">
                        <i class="fa fa-list"></i> <?php echo esc_html__('My Listings', 'adforest'); ?>
                    </a></li>
                    <?php if (isset($adforest_theme['communication_mode']) && ($adforest_theme['communication_mode'] == 'both' || $adforest_theme['communication_mode'] == 'message')) {
                        // Messages → standalone Modern page (selected via Theme Options)
                        // Falls back to the dashboard's classic Messages page if none picked yet.
                        $modern_messages_page_id = isset($adforest_theme['sb_modern_messages_page']) ? $adforest_theme['sb_modern_messages_page'] : '';
                        $messages_url = $modern_messages_page_id
                            ? get_permalink($modern_messages_page_id)
                            : adforest_set_url_param($dash_url, 'page_type', 'msg');
                    ?>
                    <li><a class="user_login_dropdown_text" href="<?php echo esc_url($messages_url); ?>">
                        <i class="fa fa-envelope"></i> <?php echo esc_html__('Messages', 'adforest'); ?>
                        <?php if ($msg_count) : ?><span class="badge bg-danger"><?php echo esc_html($msg_count); ?></span><?php endif; ?>
                    </a></li>
                    <?php } ?>
                    <?php
                    // Favorites → standalone Modern page (selected via Theme Options)
                    // Falls back to the dashboard's classic Favorites page if none picked yet.
                    $modern_favorites_page_id = isset($adforest_theme['sb_modern_favorites_page']) ? $adforest_theme['sb_modern_favorites_page'] : '';
                    $favorites_url = $modern_favorites_page_id
                        ? get_permalink($modern_favorites_page_id)
                        : adforest_set_url_param($dash_url, 'page_type', 'fav_ads');
                    ?>
                    <li><a class="user_login_dropdown_text" href="<?php echo esc_url($favorites_url); ?>">
                        <i class="fa fa-heart"></i> <?php echo esc_html__('Favorites', 'adforest'); ?>
                    </a></li>
                    <?php
                    // My Packages → standalone Modern page (selected via Theme Options)
                    // Falls back to the dashboard's classic My Packages page if none picked yet.
                    $modern_packages_page_id = isset($adforest_theme['sb_modern_my_packages_page']) ? $adforest_theme['sb_modern_my_packages_page'] : '';
                    $packages_url = $modern_packages_page_id
                        ? get_permalink($modern_packages_page_id)
                        : adforest_set_url_param($dash_url, 'page_type', 'my_packages');
                    ?>
                    <li><a class="user_login_dropdown_text" href="<?php echo esc_url($packages_url); ?>">
                        <i class="fa fa-box"></i> <?php echo esc_html__('My Packages', 'adforest'); ?>
                    </a></li>
                    <?php
                    // Settings → standalone Modern page (selected via Theme Options)
                    // Falls back to the dashboard's classic Edit Profile page if none picked yet.
                    $modern_settings_page_id = isset($adforest_theme['sb_modern_settings_page']) ? $adforest_theme['sb_modern_settings_page'] : '';
                    $settings_url = $modern_settings_page_id
                        ? get_permalink($modern_settings_page_id)
                        : adforest_set_url_param($dash_url, 'page_type', 'my_profile');
                    ?>
                    <li><a class="user_login_dropdown_text" href="<?php echo esc_url($settings_url); ?>">
                        <i class="fa fa-cog"></i> <?php echo esc_html__('Profile Settings', 'adforest'); ?>
                    </a></li>
                    <li class="adt-user-divider"></li>
                    <li><a class="user_login_dropdown_text" href="<?php echo esc_url(wp_logout_url(get_the_permalink($sb_sign_in_page))); ?>">
                        <i class="fa fa-power-off"></i> <?php echo esc_html__('Log Out', 'adforest'); ?>
                    </a></li>
                </ul>
            </div>
            <?php
