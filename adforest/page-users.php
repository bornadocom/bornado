                            ...
                            <div class="listingTopFilterBar">
                                ...
                                <div class="col-md-5 col-xs-12 col-sm-5 no-padding">
                                    <div class="header-listing">
                                        <h6><?php esc_html_e('Sort by','adforest') ;?> </h6>
                                        <div class="custom-select-box pull-right">
                                            <form method="get">
                                                <select name="sort" id="user_order_by" class="custom-select order_by select2-hidden-accessible" data-select2-id="order_by" tabindex="-1" aria-hidden="true">
                                                    ...
                                                    <option value="asc"  <?php echo adforest_return_echo($order == "asc" ? "selected" : ""); ?>><?php esc_html_e('A-Z', 'adforest'); ?></option>
                                                    <option value="desc" <?php echo adforest_return_echo($order == "desc" ? "selected" : "") ?>><?php esc_html_e('Z-A', 'adforest'); ?></option>
