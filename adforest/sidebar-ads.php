...
<?php if ( $show_mob_filter ) { ?>
    <div id="adforest-ajax-sidebar" class="adforest-ajax-sidebar <?php echo esc_attr($ext_class);
	echo adforest_return_echo( $show_mob_filter ) ? 'mobile-filters' : ''; ?>">
        <div class="mobile-filter-heading"><h1><?php echo esc_html__( "Search Filters", "adforest" ); ?></h1></div>
