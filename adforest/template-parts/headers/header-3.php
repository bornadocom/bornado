                ...
                <div class="col-lg-12">
                    <div class="adt-multivendor-searchbar-wrapper">
                        ...
                        <div class="adt-extra-buttons">
                            <div class="cart-box">
                                <div class="meta">
                                    <small><?php echo esc_html__("Shopping Cart:", "adforest"); ?></small>
                                    <strong>
                                        <?php
                            ...
                            <div class="product-favourite-sb">
                                <ul class="product-section-content">
                                    ...
                                    <?php if(is_array($products) && count($products) > 5) {
	                                    ...
	                                    echo '<a href="' . get_the_permalink($sb_profile_page) . '" class="no-margin-my-custom adt-button-dark">' . esc_html__("View All", "adforest") . '</a>';
	                                    echo "</li>";
                                    } ?>
                                </ul>
                            </div>
                        ...
                        <div class="dropdown category-dropdown">
                            <form id="shop-categories-select" method="get" action="<?php echo esc_url($shop_url); ?>">
                                <button class="btn btn-secondary dropdown-toggle" type="button"
                                        ...
                                        aria-expanded="false">
                                    <?php echo esc_html__("Categories", "adforest"); ?>
                                </button>
