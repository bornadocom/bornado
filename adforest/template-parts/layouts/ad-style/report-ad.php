        ...
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="btn close" data-bs-dismiss="modal"><span
                            ...
                            class="sr-only"><?php echo esc_html__('Close', 'adforest'); ?></span></button>
                <div class="modal-title"><?php echo esc_html__('Why are you reporting this ad?', 'adforest'); ?></div>
            </div>
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group  col-md-12 col-sm-12">
                        ...
                        <textarea placeholder="<?php echo esc_attr__('Write your comments.', 'adforest'); ?>" rows="3"
                    ...
                    <div class="col-md-12 col-sm-12 margin-bottom-20 margin-top-20">
                        ...
                        <button type="button" class="adt-button-dark btn-block"
                                id="sb_mark_it"><?php echo esc_html__('Submit', 'adforest'); ?></button>
