...
$is_bidable = get_post_meta(get_the_ID(), '_adforest_ad_bidding', true);
$adt_container_class = "";
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="ad-detail-middle-content">
                                ...
                                <div class="adt-product-or-seller-mobile-box">
                                    <?php
                                    if (isset($adforest_theme['sb_enable_comments_offer']) && $adforest_theme['sb_enable_comments_offer']) {
                                        $bid_date = get_post_meta($pid, '_adforest_ad_bidding_date', true);
                                        if (!$bid_date) {
                                            $bid_date = date('Y-m-d', strtotime('+7 days', current_time('timestamp')));
                                        }
                                        $bidding_enabled = get_post_meta($pid, '_adforest_ad_bidding', true);
                                    ...
                                    <div class="adt-product-detail-box">
                                        <div class="detail-box">
                                            ...
                                            <div class="views">
                                                ...
                                                // Check if views are 1000 or more
                                                if ($ad_views >= 1000) {
                                            ...
                                            <?php } else {
                                                    echo '<span class="price">' . adforest_adPrice($pid, 'negotiable-single', '') . '</span>';
                                                }
                                            }
                                            ?>
                                            ...
                                            ?>
                                            <span class="date"><i
                                                    class="far fa-calendar-alt"></i><?php echo esc_html($ad_posted_date); ?></span>
                                        ...
                                        <div class="actions-box">
                                            ...
                                            if (class_exists('SB_Chat') && $allow_sb_chat === '1') {
                                                ...
                                                if (isset($sb_plugin_options['sbChat-active']) && $sb_plugin_options['sbChat-active'] == 1 && class_exists('SB_Chat_Setting_Page')) {
                                                    $classes = 'adt-button-dark-1';
                                                    $icon = 'far fa-comment-alt';
                                                    $button_text = esc_html__('Chat', 'adforest');
                                                    $pid = get_the_ID();
                                            ...
                                            <a class="ad_to_fav<?php echo esc_attr( $fav_extra ); ?>" data-adid="<?php echo get_the_ID(); ?>"
                                                ...
                                                <i class="<?php echo esc_attr($heart_class); ?>"></i></a>
                                    ...
                                    <div class="adt-product-author-detail-box">
                                        <div class="author-box">
                                            ...
                                            ?>
                                            <?php if ($user_type != "") { ?>
                                                <span class="designation"><?php echo adforest_return_echo($user_type); ?></span>
                                            <?php } ?>
                                            ...
                                            <div class="author-meta">
                                                <h4>
                                                    <a href="<?php echo adforest_set_url_param(get_author_posts_url($poster_id), 'type', 'ads'); ?>"><?php echo esc_html($poster_name . " "); ?> </a>
                                                    <?php
                                                    if ($is_phone_verified == '1') {
                                                    ?>
                                                        <span class="verified">
                                        ...
                                        <div class="location-box">
                                            <a href="#adt-ad-location-box"
                                                class="map"><?php echo esc_html__("see map", "adforest"); ?></a>
                                            <img src="<?php echo trailingslashit(get_template_directory_uri()) . 'images/location-icon.svg' ?>"
                                                alt="location"> <?php echo esc_html($truncated_location); ?>
                                        </div>
                                        <?php
                                                    ...
                                                    <div class="contact-box-main">
                                                        ...
                                                        <a href="<?php echo esc_url($call_now); ?>"
                                                            ...
                                                            <div class="contact-box whatsapp">
                                                                <div class="icon">
                                                                    <img src="<?php echo trailingslashit(get_template_directory_uri()) . 'images/whatsapp-icon.svg' ?>"
                                                                        alt="icon">
                                                                </div>
                                                                <div class="meta">
                                                                    <small class="toggle-contact-number"
                                                                        data-ad-id="<?php echo intval($poster_id); ?>">
                                                                        <?php echo esc_html__("Login to View", "adforest"); ?>
                                                                    </small>
                                                                    <span class="style_2_ph"><?php echo esc_html($masked_num); ?></span>
                                                                </div>
                                                            </div>
                                                        </a>
                                                        ...
                                                        <a href="<?php echo esc_url($call_now); ?>"
                                                            ...
                                                            <div class="contact-box phone-2">
                                                                <div class="icon">
                                                                    <img src="<?php echo trailingslashit(get_template_directory_uri()) . 'images/phone-icon.svg' ?>"
                                                                        alt="icon">
                                                                </div>
                                                                <div class="meta">
                                                                    <small class="toggle-contact-number"
                                                        ...
                                                        <div class="contact-box whatsapp">
                                                            ...
                                                            <div class="meta">
                                                                <small style="cursor: pointer;"
                                                                    ...
                                                                    data-ad-id="<?php echo intval($pid); ?>"><?php echo esc_html__("Click To Show", "adforest"); ?>
                                                                </small>
                                        ...
                                        <?php if (($adforest_theme['communication_mode'] == 'both' || $adforest_theme['communication_mode'] == 'message') && $ad_status == 'active') { ?>
                                            <div id="message_box" class="message-box text-center">
                                                <?php if ($allow_whatsapp && $contact_num != "") {
                                                    ...
                                                    $ad_message = $post_title . " - " . $post_link;
                                                    ...
                                                    if (isset($adforest_theme['sb_show_whatsapp_intro']) && $adforest_theme['sb_show_whatsapp_intro'] == '1') {
                                                        ...
                                                        $text_content = $ad_message;
                                                        if (!empty($whatsapp_intro)) {
                                                            $text_content .= "\n" . $whatsapp_intro;
                                                        }
                                                        $redirect_url = "https://api.whatsapp.com/send?phone={$contact_num}&text=" . urlencode($text_content);
                                                    } else {
                                                        $redirect_url = "https://api.whatsapp.com/send?phone={$contact_num}&text=" . urlencode($ad_message);
                                                    }
                                    ...
                                    <div id="adt-ad-location-box" class="adt-ad-location-box">
                                        ...
                                        ?>
                                            ...
                                            <input type="hidden" id="ad_lon"
                                                value="<?php echo esc_attr($map_long); ?>" />
                                            <?php
                                        } else {
                                                ...
                                                if ($bid_end_date != "" && date('Y-m-d H:i:s') > $bid_end_date && isset($adforest_theme['bidding_timer']) && $adforest_theme['bidding_timer']) {
                                                    ...
                                                    <form role="form" id="sb_bid_ad">
                                                        <div class="input-field-box">
                                                            ...
                                                            <div class="input-box">
                                                                <input type="text" name="bid_comment"
                                                                    id="bid_comment"
                        ...
                        <div class="col-lg-4">
                            ...
                            if (is_active_sidebar('adforest_ad_sidebar_bottom')) {
                                echo '<div class = "ad-bottom-sidebar style_2_bottom_sidebar">';
