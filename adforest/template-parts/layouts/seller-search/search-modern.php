        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <div class="adt-ads-sort-box">
                    <h3 class="sellers_found_heading"><?php printf( esc_html__( '%s Sellers Found', 'adforest' ), esc_html( $total_users ) ); ?>
                        :</h3>
                ...
                <?php if (!empty($user_query->get_results())) { ?>
                    <div class="adt-seller-cards-grid">
                        ...
                        foreach ($user_query->get_results() as $user) {
                            ...
                            if (get_user_meta($author_id, '_sb_user_type', true) == 'Indiviual') {
                                $user_role = esc_html__('Individual', 'adforest');
                            } else if (get_user_meta($author_id, '_sb_user_type', true) == 'Dealer') {
                                $user_role = esc_html__('Dealer', 'adforest');
                            }
                            ?>
                    ...
                    <div class="adt-ad-not-found">
                        ...
                        <h3><?php esc_html_e('No Sellers found.', 'adforest'); ?></h3>
                    </div>
                <?php }
                ?>
