...
class Plugin {
    ...
    private function include_widgets_files() {
        $files = [
            ...
            // Modern Home (new) — six standalone section widgets
            'AdfHomeHero.php',
            'AdfHomeCategories.php',
            'AdfHomeFeatured.php',
            'AdfHomeLocations.php',
            'AdfHomePricing.php',
            'AdfHomeTrust.php',
        ];
    ...
    public function register_widgets( Widgets_Manager $manager ) {
        ...
        $widgets = [
            ...
            // Modern Home — six standalone section widgets
            new Widgets\AdfHomeHero(),
            new Widgets\AdfHomeCategories(),
            new Widgets\AdfHomeFeatured(),
            new Widgets\AdfHomeLocations(),
            new Widgets\AdfHomePricing(),
            new Widgets\AdfHomeTrust(),
        ];
